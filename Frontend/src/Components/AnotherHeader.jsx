    ...
    <>
      <header className="bg-[#E9762B] md:h-20 min-[320px]:h-[60px] md:px-5 min-[320px]:px-1 ">
        <nav className="flex justify-between items-center h-full">
          ...
          <Link to="/">
          <button  className="md:text-2xl min-[320px]:text-[16px] font-bold text-[#E9762B] bg-white md:rounded-md min-[320px]:rounded mt-3 hover:scale-105 transition md:px-4 md:py-2 min-[320px]:px-2 min-[320px]:py-1">
            LogIn
          </button>
          </Link>
        </nav>
